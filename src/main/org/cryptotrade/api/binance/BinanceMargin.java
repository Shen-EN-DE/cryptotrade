...
public class BinanceMargin extends BinanceBaseApi{
	private static Logger Log = LogManager.getLogger();
	public BinanceMargin(String _apiKey,String _apiSecret) {
		this.apiKey = _apiKey;
		this.apiSecret = _apiSecret;
		this.baseUrl = "https://api.binance.com";
		this.baseEndPointUrl = "/sapi/v1/margin";
	}
	
	public JSONObject getTransfer(Map<String,String> param){
		return null;
	}
	 ...
	 * isIsolated - Boolean : (選填)是否逐仓杠杆<br>
	 ...
	 * sideEffectType - String : (選填)NO_SIDE_EFFECT, MARGIN_BUY, AUTO_REPAY;默认为 NO_SIDE_EFFECT.<br>
	 ...
	 * </ul>
	 * origClientOrderId或orderId必須填入其中一個
	 * @return JSONObject
	 ...
	 * <ul>
	 * symbol - String : 交易標的,Ex BTCUSDT<br>
	 * isIsolated - String : 交易標的,Ex BTCUSDT<br>
	 * orderId - Long: (選填)訂單ID<br>
